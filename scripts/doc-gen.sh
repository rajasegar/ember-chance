...
touch "tests/dummy/app/templates/$helper.hbs"
  ...
  # Generate route definitions in router.js
...
while read -r helper; do
  ...
  helper_name="chance-$snake_case"
  caps="Chance-$snake_case"
  ...
  # Generate links in application template
  #echo "<li>
  #<LinkTo @route=\"$helper_name\">$helper_name</LinkTo>
  #</li>" >> tests/dummy/app/templates/application.hbs
